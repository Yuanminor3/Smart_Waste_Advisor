...
const char* ei_classifier_inferencing_categories[] = { "battery", "biological", "cardboard", "clothes", "glasses", "metal", "paper", "plastic", "shoes", "trash" };
...
const ei_impulse_t impulse_683785_0 = {
    .project_id = 683785,
    .project_owner = "Yuan Jiang",
    .project_name = "xiao_esp32s3_waste_classification_12Classes",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_683785_0 = ei_impulse_handle_t( &impulse_683785_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_683785_0;
